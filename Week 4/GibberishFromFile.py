...
# Initialize variables
    text_object = open("inputFile.txt", "r")
    gibberish_obj = open("inputFileGibberish.txt", "a")
    i = 0
    vowels = "aeiouAEIOU"
    syllable = 1
    new_word = ''
...
# word check
    for word in text_object:
        ...
        print(new_word, file = gibberish_obj) #Print out resulting word

    text_object.close()      # close inputFile object
    gibberish_obj.close()    # close inputFileGibberish object
